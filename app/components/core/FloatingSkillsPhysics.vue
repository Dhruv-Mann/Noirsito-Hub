...
function initPhysics() {
  ...
  skillLabels.forEach((label, i) => {
    ...
    // 40% Slower floating speed for deliberate, elegant physics motion
...
function updatePhysics() {
  ...
  for (let i = 0; i < list.length; i++) {
    ...
    // 3. Invisible Ribbon Buffer Collision (Center Knot Exclusion)
    ...
    // 4. Badge-to-Badge Elastic Collision Physics
