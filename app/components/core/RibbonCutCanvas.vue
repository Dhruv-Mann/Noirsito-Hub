...
function render() {
  ...
  // 1. END-TO-END HORIZONTAL LISSAJOUS TAILS (Left Tail & Right Tail)
  const tailStrands = 5
  ...
  // 2. AUTHENTIC BUTTERFLY BOW-TIE RIBBON LOOPS (Flared wings tapering into tight center knot)
  const bowLayers = 4
  ...
  for (let layer = 0; layer < bowLayers; layer++) {
    ...
    for (let i = 0; i <= 360; i += 2) {
      ...
      // Butterfly Bow-Tie Parametric Equation
...
/* Minimalist Bouncing Cursor at Center Knot */
